    ...
    return (
      <div className="App nftapp">
              ...
              <form>
                ...
                <div className="row px-2 pb-2 row-style">
                  <div className="col ">
                    ...
                    >
                      <img src={"skdr-logo.png"} width="100%" />
                    </Button>
                  </div>
                  <div className="col">
                    <Button
              ...
              <form style={{ fontFamily: "SF Pro Display" }}>
                ...
                <div className="row px-4 pt-2">
                  <div class="header">
                    ...
                    >
                      SKDR NFT Staking Pool Active Rewards
                    </div>
                      ...
                      <tbody>
                        ...
                        <tr className="stakegoldeffect">
                          ...
                          <td class="exchange">
                            ...
                            <span class="currency">100 SKDR/M</span>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                    ...
                    <div class="header">
                      ...
                      >
                        ...
                        <tbody>
                          <tr>
                            <td>Stake SKDR to Earn SKDR</td>
                            <td
                              class="amount"
                              data-test-id="rewards-summary-ads"
                            >
                              <span class="amount">0.01</span>&nbsp;
                              <span class="currency">Per SKDR</span>
                            </td>
                          </tr>
                          <tr>
                            <td>Stake SKDR to Earn SKDR+</td>
        ...
        <div className="row nftportal mt-3">
          ...
          <div className="col">
            <h1 className="skdtitlestyle mt-3">Your NFT Portal</h1>
            <Button
              onClick={refreshPage}
              style={{
